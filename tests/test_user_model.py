...
class UserModelTestCase(unittest.TestCase):
    ...
    def test_events(self):
        ...
        self.assertFalse(u1.is_go(e1))
        self.assertFalse(u2.is_go(e1))
        self.assertFalse(u3.is_go(e1))
        self.assertFalse(u4.is_not_go(e1))
        ...
        db.session.add(u2)
        db.session.add(u3)
        self.assertTrue(u1.is_go(e1))
        self.assertFalse(u2.is_go(e1))
        self.assertFalse(u3.is_not_go(e1))
        self.assertFalse(u4.is_go(e1))
        self.assertTrue(e1.is_rsvp(u1))
        self.assertFalse(e1.is_rsvp(u4))

        u1.ungo(e1)
        u2.ungo(e1)
        self.assertTrue(u1.is_not_go(e1))
        self.assertFalse(u1.is_go(e1))
        self.assertFalse(u2.is_go(e1))
